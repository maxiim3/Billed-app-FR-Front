    ...
    <div class='layout'>
      ...
      <div class='dashboard-content'>
        <div class='bills-feed'>
          ...
          <div class='status-bills-container' id='status-bills-container1' data-open="false">
          </div>
            ...
            <div class='status-bills-container' id='status-bills-container2' data-open="false">
            </div>
            ...
            <div class='status-bills-container' id='status-bills-container3' data-open="false">
            </div>
